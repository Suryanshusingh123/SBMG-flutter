...
class SmdGpRankingScreen extends StatefulWidget {
  ...
  @override
  State<SmdGpRankingScreen> createState() => _SmdGpRankingScreenState();
}

class _SmdGpRankingScreenState extends State<SmdGpRankingScreen> {
  ...
  Future<void> _initialize() async {
    try {
      final districtId =
          widget.initialDistrictId ?? await _auth.getSmdSelectedDistrictId();
      if (districtId == null) {
        setState(() {
