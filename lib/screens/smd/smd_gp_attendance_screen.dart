...
class SmdGpAttendanceScreen extends StatefulWidget {
  ...
  @override
  State<SmdGpAttendanceScreen> createState() => _SmdGpAttendanceScreenState();
}

class _SmdGpAttendanceScreenState extends State<SmdGpAttendanceScreen> {
