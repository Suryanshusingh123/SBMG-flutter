...
class CeoInspectionLogScreen extends StatefulWidget {
  const CeoInspectionLogScreen({super.key});

  @override
  State<CeoInspectionLogScreen> createState() => _CeoInspectionLogScreenState();
}

  class _CeoInspectionLogScreenState extends State<CeoInspectionLogScreen> {
