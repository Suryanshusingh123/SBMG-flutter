...
class CeoGpAttendanceScreen extends StatefulWidget {
  ...
  @override
  State<CeoGpAttendanceScreen> createState() => _CeoGpAttendanceScreenState();
}

class _CeoGpAttendanceScreenState extends State<CeoGpAttendanceScreen> {
  ...
  Future<void> _initialize() async {
    final blockId = widget.blockId ?? await _authService.getBlockId();
    final districtId = widget.districtId ?? await _authService.getDistrictId();
    setState(() {
      _blockId = blockId;
